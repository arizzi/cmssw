...
namespace pat {
  ...
  public:
    ...
    PackedCandidate() :
      ...
      m_(), packedHits_(0), normalizedChi2_(0) { }
    ...
    explicit PackedCandidate( const reco::Candidate & c,
      ...
      pvRefKey_(pvRefKey),m_(), packedHits_(0),
      normalizedChi2_(0) {
      packBoth();
    }
    ...
    PackedCandidate( const PackedCandidate& iOther) :
      ...
      m_(iOther.m_),
      packedHits_(iOther.packedHits_), normalizedChi2_(iOther.normalizedChi2_) {
      }
   ...
   /// transverse energy 
    ...
    virtual void setHits(int pixels,int strips)
    {
      int numberOfPixelHits_ = pixels;
      if (numberOfPixelHits_ > trackPixelHitsMask) numberOfPixelHits_ = trackPixelHitsMask;
      int numberOfStripHits_ = strips-pixels;
