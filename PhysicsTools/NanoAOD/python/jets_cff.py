...
from RecoJets.JetProducers.PileupJetID_cfi import _chsalgos_94x,pileupJetId
pileupJetId.jets=cms.InputTag("updatedJets")
pileupJetId.inputIsCorrected=True
pileupJetId.applyJec=False
pileupJetId.vertexes = cms.InputTag("offlineSlimmedPrimaryVertices")
pileupJetId.algos = cms.VPSet(_chsalgos_94x)
...
updatedJetsWithUserData = cms.EDProducer("PATJetUserDataEmbedder",
     ...
     userInts = cms.PSet(
        ...
        puid2017 = cms.InputTag('pileupJetId:fullId'),
...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        puId17 = Var("userInt('puid2017')",int,doc="Pilup ID flags, 2017 dedicated training"),
...
jetSequence = cms.Sequence()
