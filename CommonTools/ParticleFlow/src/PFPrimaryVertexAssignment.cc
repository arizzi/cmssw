...
PFPrimaryVertexAssignment::chargedHadronVertex( const reco::VertexCollection& vertices,
  ...
  if(iVertex >= 0 ) return std::pair<int,PFPrimaryVertexAssignment::Quality>(iVertex,PFPrimaryVertexAssignment::UsedInFit);
  ...
  if(iVertex >= 0 ) return std::pair<int,PFPrimaryVertexAssignment::Quality>(iVertex,PFPrimaryVertexAssignment::PrimaryDz);
  ...
  if(vtxIdMinDz>=0)
     return std::pair<int,PFPrimaryVertexAssignment::Quality>(vtxIdMinDz,PFPrimaryVertexAssignment::OtherDz);
