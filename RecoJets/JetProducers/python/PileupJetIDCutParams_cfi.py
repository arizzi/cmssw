...
full_94x_chs_wp  = cms.PSet(
    ...
    #Tight Id: Background Eff - {Eta 0-3.0: 1%} {Eta 3.0-5.0: 20%}
    Pt010_Tight    = cms.vdouble(0.924,  0.925,  0.924,  0.924,  0.924,  0.924,  0.875,  0.161),
    Pt1020_Tight   = cms.vdouble(0.924,  0.925,  0.924,  0.924,  0.924,  0.924,  0.875,  0.161),
    Pt2030_Tight   = cms.vdouble(0.924,  0.925,  0.924,  0.924,  0.924,  0.924,  0.875,  0.161),
    Pt3050_Tight   = cms.vdouble(0.924,  0.925,  0.924,  0.924,  0.924,  0.924,  0.875,  0.161),
    #Signal Eff                  80.8 %, 79.5 %, 76.3 %, 72.0 %, 70.0 %, 65.3 %, 44.6 %, 56.8 %

    #Medium Id: Background Eff - {Eta 0-3.0: 5%} {Eta 3.0-5.0: 30%}
    Pt010_Medium   = cms.vdouble(-0.275, -0.125,  0.075,  0.075,  0.226,  0.327,  0.530, -0.013),
    Pt1020_Medium  = cms.vdouble(-0.275, -0.125,  0.075,  0.075,  0.226,  0.327,  0.530, -0.013),
    Pt2030_Medium  = cms.vdouble(-0.275, -0.125,  0.075,  0.075,  0.226,  0.327,  0.530, -0.013),
    Pt3050_Medium  = cms.vdouble(-0.275, -0.125,  0.075,  0.075,  0.226,  0.327,  0.530, -0.013),
    #Signal Eff                  97.8 %, 96.9 %, 96.0 %, 95.2 %, 92.5 %, 87.7 %, 66.5 %, 69.8 %

    #Loose Id: Background Eff - {Eta 0-3.0: 10%} {Eta 3.0-5.0: 40%}
    Pt010_Loose    = cms.vdouble(-0.774, -0.724, -0.674, -0.674, -0.422, -0.221,  0.185, -0.100),
    Pt1020_Loose   = cms.vdouble(-0.774, -0.724, -0.674, -0.674, -0.422, -0.221,  0.185, -0.100),
    Pt2030_Loose   = cms.vdouble(-0.774, -0.724, -0.674, -0.674, -0.422, -0.221,  0.185, -0.100),
    Pt3050_Loose   = cms.vdouble(-0.774, -0.724, -0.674, -0.674, -0.422, -0.221,  0.185, -0.100)
    #Signal Eff                  98.9 %, 98.5 %, 98.2 %, 97.7 %, 96.2 %, 92.9 %, 76.4 %, 75.8 %
)
