...
full_94x_chs = cms.PSet(
        ...
        version = cms.int32(-1),
        nEtaBins = cms.int32(8),
        trainings = cms.VPSet(
            cms.PSet(
                jEtaMin = cms.double(0.0),
                jEtaMax = cms.double(1.0),
                tmvaWeights  = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta0p0To1p0_chs_BDT.weights.xml.gz"),
            ...
            cms.PSet(
                jEtaMin = cms.double(1.0),
                jEtaMax = cms.double(1.5),
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta1p0To1p5_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
            ...
            cms.PSet(
                jEtaMin = cms.double(1.5),
                jEtaMax = cms.double(2.0),
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta1p5To2p0_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
            ...
            cms.PSet(
                ...
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta2p0To2p5_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
            ...
            cms.PSet(
                ...
                jEtaMax = cms.double(2.6),
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta2p5To2p6_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
            ...
            cms.PSet(
                jEtaMin = cms.double(2.6),
                jEtaMax = cms.double(2.7),
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta2p6To2p7_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
            ...
            cms.PSet(
                jEtaMin = cms.double(2.7),
                jEtaMax = cms.double(3.0),
                tmvaWeights   = cms.string("RecoJets/JetProducers/data/pileupJetId_94X_Eta2p7To3p0_chs_BDT.weights.xml.gz"),
                tmvaVariables = cms.vstring(
                    "nvtx"      ,
                    "dR2Mean"   ,
                    "nParticles",
