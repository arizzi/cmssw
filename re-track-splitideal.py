...
process.p = cms.Path(process.siPixelClusters*process.MeasurementTrackerEvent* process.siPixelClusterShapeCache+process.siPixelRecHits+process.siStripMatchedRecHits+process.ckftracks_wodEdX+process.offlinePrimaryVertices+process.ak4JetTracksAssociatorAtVertexPF*process.btagging*process.compare)
